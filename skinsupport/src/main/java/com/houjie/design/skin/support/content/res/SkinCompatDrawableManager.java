...
import static com.houjie.design.skin.support.content.res.SkinCompatThemeUtils.getDisabledThemeAttrColor;
import static com.houjie.design.skin.support.content.res.SkinCompatThemeUtils.getThemeAttrColor;
import static com.houjie.design.skin.support.content.res.SkinCompatThemeUtils.getThemeAttrColorStateList;
...
public final class SkinCompatDrawableManager {
    ...
    public synchronized static SkinCompatDrawableManager getInstance() {
        if (sInstance == null) {
    ...
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = {
            android.support.v7.appcompat.R.drawable.abc_textfield_search_default_mtrl_alpha,
            android.support.v7.appcompat.R.drawable.abc_textfield_default_mtrl_alpha,
            android.support.v7.appcompat.R.drawable.abc_ab_share_pack_mtrl_alpha
    };
    ...
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = {
            android.support.v7.appcompat.R.drawable.abc_textfield_activated_mtrl_alpha,
            android.support.v7.appcompat.R.drawable.abc_textfield_search_activated_mtrl_alpha,
            android.support.v7.appcompat.R.drawable.abc_cab_background_top_mtrl_alpha,
            android.support.v7.appcompat.R.drawable.abc_text_cursor_material,
            android.support.v7.appcompat.R.drawable.abc_text_select_handle_left_mtrl_dark,
            android.support.v7.appcompat.R.drawable.abc_text_select_handle_middle_mtrl_dark,
            android.support.v7.appcompat.R.drawable.abc_text_select_handle_right_mtrl_dark,
            android.support.v7.appcompat.R.drawable.abc_text_select_handle_left_mtrl_light,
            android.support.v7.appcompat.R.drawable.abc_text_select_handle_middle_mtrl_light,
            android.support.v7.appcompat.R.drawable.abc_text_select_handle_right_mtrl_light
    };
    ...
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = {
            android.support.v7.appcompat.R.drawable.abc_popup_background_mtrl_mult,
            android.support.v7.appcompat.R.drawable.abc_cab_background_internal_bg,
            android.support.v7.appcompat.R.drawable.abc_menu_hardkey_panel_mtrl_mult
    };
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        ...
        final Drawable d = getDrawable(context, android.support.v7.appcompat.R.drawable.abc_vector_test);
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context,
        ...
        if (resId == android.support.v7.appcompat.R.drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{
                    getDrawable(context, android.support.v7.appcompat.R.drawable.abc_cab_background_internal_bg),
                    getDrawable(context, android.support.v7.appcompat.R.drawable.abc_cab_background_top_mtrl_alpha)
            });
        }
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId,
        ...
        if (tintList != null) {
        ...
        } else if (resId == android.support.v7.appcompat.R.drawable.abc_seekbar_track_material) {
            LayerDrawable ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.background),
                    getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorControlNormal), DEFAULT_MODE);
            ...
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.progress),
                    getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorControlActivated), DEFAULT_MODE);
        } else if (resId == android.support.v7.appcompat.R.drawable.abc_ratingbar_material
                || resId == android.support.v7.appcompat.R.drawable.abc_ratingbar_indicator_material
                || resId == android.support.v7.appcompat.R.drawable.abc_ratingbar_small_material) {
            LayerDrawable ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.background),
                    getDisabledThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorControlNormal),
                    DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.secondaryProgress),
                    getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(android.R.id.progress),
    ...
    ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            ...
            if (resId == android.support.v7.appcompat.R.drawable.abc_edit_text_material) {
                tint = SkinCompatResources.getColorStateList(context, android.support.v7.appcompat.R.color.abc_tint_edittext);
            } else if (resId == android.support.v7.appcompat.R.drawable.abc_switch_track_mtrl_alpha) {
                tint = SkinCompatResources.getColorStateList(context, android.support.v7.appcompat.R.color.abc_tint_switch_track);
            } else if (resId == android.support.v7.appcompat.R.drawable.abc_switch_thumb_material) {
                tint = createSwitchThumbColorStateList(context);
            } else if (resId == android.support.v7.appcompat.R.drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context);
            } else if (resId == android.support.v7.appcompat.R.drawable.abc_btn_borderless_material) {
                tint = createBorderlessButtonColorStateList(context);
            } else if (resId == android.support.v7.appcompat.R.drawable.abc_btn_colored_material) {
                tint = createColoredButtonColorStateList(context);
            } else if (resId == android.support.v7.appcompat.R.drawable.abc_spinner_mtrl_am_alpha
                    || resId == android.support.v7.appcompat.R.drawable.abc_spinner_textfield_background_material) {
                tint = SkinCompatResources.getColorStateList(context, android.support.v7.appcompat.R.color.abc_tint_spinner);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                tint = getThemeAttrColorStateList(context, android.support.v7.appcompat.R.attr.colorControlNormal);
            } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                tint = SkinCompatResources.getColorStateList(context, android.support.v7.appcompat.R.color.abc_tint_default);
            } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                tint = SkinCompatResources.getColorStateList(context, android.support.v7.appcompat.R.color.abc_tint_btn_checkable);
            } else if (resId == android.support.v7.appcompat.R.drawable.abc_seekbar_thumb_material) {
                tint = SkinCompatResources.getColorStateList(context, android.support.v7.appcompat.R.color.abc_tint_seek_thumb);
            }
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        ...
        if (thumbColor != null && thumbColor.isStateful()) {
            ...
            colors[i] = getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorControlActivated);
            i++;
            ...
            // Disabled state
            states[i] = SkinCompatThemeUtils.DISABLED_STATE_SET;
            colors[i] = getDisabledThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorSwitchThumbNormal);
            i++;
            ...
            // Default enabled state
            states[i] = SkinCompatThemeUtils.EMPTY_STATE_SET;
            colors[i] = getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorSwitchThumbNormal);
            i++;
        }
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context,
                getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createButtonColorStateList(@NonNull final Context context,
        ...
        final int colorControlHighlight = getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorControlHighlight);
        final int disabledColor = getDisabledThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorButtonNormal);
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context,
                getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorAccent));
    }
    ...
    static PorterDuff.Mode getTintMode(final int resId) {
        ...
        if (resId == android.support.v7.appcompat.R.drawable.abc_switch_thumb_material) {
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context,
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, resId)) {
            colorAttr = android.support.v7.appcompat.R.attr.colorControlNormal;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, resId)) {
            colorAttr = android.support.v7.appcompat.R.attr.colorControlActivated;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, resId)) {
            colorAttr = android.R.attr.colorBackground;
            colorAttrSet = true;
            tintMode = PorterDuff.Mode.MULTIPLY;
        } else if (resId == android.support.v7.appcompat.R.drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = android.R.attr.colorForeground;
            colorAttrSet = true;
            alpha = Math.round(0.16f * 255);
        } else if (resId == android.support.v7.appcompat.R.drawable.abc_dialog_material_background) {
            colorAttr = android.R.attr.colorBackground;
            colorAttrSet = true;
        }
